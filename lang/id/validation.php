...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => ':Attribute yang diberikan pernah bocor dalam kebocoran data. Gunakan :attribute lain.',
    ],
    ...
    */
    'custom' => [
        'email' => [
            'unique' => 'Email sudah digunakan oleh akun lain.',
        ],
        'phone' => [
            'regex'  => 'Format nomor HP tidak valid. Gunakan format 628xxxxxxxx.',
            'unique' => 'Nomor HP sudah digunakan oleh akun lain.',
        ],
        'password' => [
